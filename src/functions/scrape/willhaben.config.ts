...
const willHabenConfig: WillHabenConfig = {
  AREA_ID: [
    ...
    VIENNADISTRICTS.EIGHTEENTH,
    VIENNADISTRICTS.NINETEENTH,
    VIENNADISTRICTS.FIFTEENTH,
    VIENNADISTRICTS.TWENTIETH,
    VIENNADISTRICTS.TWENTYFIRST,
    VIENNADISTRICTS.TWENTYSECOND,
    VIENNADISTRICTS.TWENTYTHIRD,
  ],
  PROPERTY_TYPE: [
